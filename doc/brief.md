...
The FSBL can sometime be packaged with the SSBL, U-BOOT offers its own ("U-Boot SPL")
...
We will be using the linux kernel for this project.

This is the piece of software that abstract the hardware for the "userspace".

### root

This is the target 'root' (rootfs) that contains everything that will run on your target system.  
...
For this project we will be using u-boot for the ssbl.  
It is lightweight and popular amoung embedded systems.
